...
export default function WorkSpacePopUp({children,closePopUp=()=>console.log('default action')}:props){
    ...
    return (
        <>
            ...
            <div className="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] bg-[var(--gray)] rounded-[10px] w-[30em] h-[auto] shadow-[0_0_14px_0_var(--dark-blue)] max-[768px]:w-[80%] text-[14px]" >
                {children}
            </div>
        </>
