...
import SignUpImg from '../../assets/SystemeSVG/signUp.svg';
...
export default function SignUp(){
    ...
    <> 
        <div className="w-[100%] h-[100%] flex justify-center items-center max-[768px]:hidden">
            <img src={SignUpImg} alt="" className="w-[22em] h-[22em] " />
        </div>
        <div className="w-[100%]  max-[768px]:row-[1/3] flex flex-col justify-center items-center pt-[5em] pb-[1em]">
            ...
            <IconBtn label='sign up with google' />
            ...
            <InputFiled label='First Name' placeHolader='younes' value={firstName} onChange={setFirstName} />
            <InputFiled label='Last Name' placeHolader='younes' value={lastName} onChange={setLastName} />
            ...
            <WidBlueBtn onClick={signUp} label='Sign Up' />
            <LogLink label={'Already have an account?'} to='/log' />
        </div>
