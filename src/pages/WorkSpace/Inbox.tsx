...
export default function Inbox (){
    return (
        <div className="w-[100%] h-[100%] grid grid-cols-12">
            <div className="col-[1/5] flex flex-col justify-start items-center h-[100vh]">
            ...
            <div className="bg-[var(--white)] col-[5/13]">
                <ChatHeader />
                <div className="w-[100%] h-[calc(100%-5em)] bg-[var(--white)]  h-[calc(100vh-9em)] overflow-y-scroll">
                    <ChatMessage />
                ...
                <div className="w-[100%] h-[4em]  flex justify-start items-center px-[.5em] bg-[var(--gray)]">
